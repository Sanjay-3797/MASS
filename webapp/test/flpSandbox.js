		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comworksheetworksheet-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comworksheetworksheet-display": {
								"semanticObject": "comworksheetworksheet",
								"action": "display",
								"description": "Bulk Worksheet Uploader",
								"title": "App Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.worksheet.worksheet",
									"url": sap.ui.require.toUrl("com/worksheet/worksheet")
								}
							}
						}
					}
